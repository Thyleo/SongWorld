					...
					if($mail == $mail2) {
						...
						if($mailexist == 0) {
							if($mdp == $mdp2) {
								...
								$nomplaylist = "favorisde" . $pseudo;
								$creer_playlist_default = $bdd->prepare("INSERT INTO playlists(nom, nom_utilisateur) VALUES(?, ?)");
								$creer_playlist_default->execute([$nomplaylist, $pseudo]);
